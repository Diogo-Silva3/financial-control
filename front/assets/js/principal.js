...
const categoriaInternet = $("#categoria-internet")
const categoriaNeoenergia = $("#categoria-neoenergia")
const categoriaCompesa = $("#categoria-compesa")
    ...
    $.ajax({
        ...
        success: function(body, stat, res) {
            ...
            if(relatorio.message !== undefined) {
                ...
                categoriaInternet.text(`R$ ${relatorio.internet || 0}`)
                categoriaNeoenergia.text(`R$ ${relatorio.neoenergia || 0}`)
                categoriaCompesa.text(`R$ ${relatorio.compesa || 0}`)
        ...
        <section>
            ...
            <div class="form-floating">
                <select class="form-select campo-categoria_atualiza" id="floatingSelect" aria-label="Categorias">
                    ...
                    <option value="10">Neoenergia</option>
                    <option value="11">Compesa</option>
                </select>
