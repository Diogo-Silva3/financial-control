...
$("#botao-atualiza_usuario").on("click", () => {
  ...
  alertaUsuario.text("Salvando dados...")
  alertaUsuario.css("color", "#0d6efd")
  ...
  $.ajax({
    ...
    success: function(body, stats, res) {
      ...
      alertaUsuario.css("color", "#198754")
    ...
    alertaUsuario.text("❌ Erro ao atualizar cadastro! Tente novamente.")
    alertaUsuario.css("color", "#dc3545")
    
    // Tentar atualizar tokens e recarregar dados
    setTimeout(() => {
      atualizaTokens()
      dadosUsuario()
    }, 2000)
