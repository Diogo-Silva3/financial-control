...
router
	.get('/usuarios', middlewaresAutenticacao.bearer, UsuariosController.listaUsuario)
	...
	.post('/usuarios/logout', [middlewaresAutenticacao.refresh, middlewaresAutenticacao.bearer] ,UsuariosController.logout)
